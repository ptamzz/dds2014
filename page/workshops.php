<div class="isotope js-isotope">
	...
	<div class="each-tour" style="padding: 60px;">
	...
	<div class="each-tour" style="padding-top: 60px;">
		<div class="schedule-desc">
			<h4 class="title" style="opacity: 0; margin-bottom: 25px;">.</h4>
			<h4 class="title">Workshops List</h4>
	...
	<div id="workshops-pic" class="each-tour" style="background-color: #333; width: 700px;"></div>
