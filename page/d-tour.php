...
<div class="isotope js-isotope" >
	...
	<div id="char-design" class="each-tour">
		...
		<div class="d-tour-desc">
			...
			<p>
				...
				of "Ideation", "Character Design", "Character Story" and "Final Design" will be followed.
			</p>
					
		</div>
	</div>

	<div id="product-design" class="each-tour">
		<div class="d-tour-desc">
			...
			<p>
				...
				enters the realm of emotional responses, cultural sensitivity and intuitiveness.
			</p>
		</div>
		<div class="d-tour-pic"></div>
	...
	<div id="calligraphy-design" class="each-tour">
		...
		<div class="d-tour-desc">
			...
			<p>
				Whether you are already into calligraphy or you would like to learn about it, you’ll find a lot of fun and enjoyment 
				in it.
			</p>
		</div>
	</div>
